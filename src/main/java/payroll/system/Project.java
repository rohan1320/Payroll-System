...
public class Project extends JFrame implements ActionListener {
    Project() {
        ...
        ImageIcon i1 = new ImageIcon("/home/dell/icon/payroll.jpg");
        ...
        t1.setIcon(new ImageIcon("/home/dell/icon/icons/New.png"));
        
        JMenuItem t3 = new JMenuItem("Salary");
        t3.setForeground(Color.blue);
        t3.setFont(new Font("monospaced",Font.PLAIN,12));
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon("/home/dell/icon/schedreport.png"));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon("home/dell/icon/newinvoice.png"));
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon("/home/dell/Icons/EditOpen.png"));
        ...
        s2.setMnemonic('p');
        s2.setIcon(new ImageIcon("/home/dell/icon/empreport.png"));
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon("/home/dell/icon/EXPENSE.PNG"));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon("/home/dell/icon/payments.png"));
        ...
        p2.setMnemonic('L');
        p2.setIcon(new ImageIcon("/home/dell/icon/empreport.png"));
        ...
        u1.setIcon(new ImageIcon("/home/dell/Icons/New.png"));
        ...
        u2.setIcon(new ImageIcon("/home/dell/icon/calc.png"));
        ...
        u3.setIcon(new ImageIcon("/home/dell/icon/explorer.jpg"));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon("/home/dell/icon/exit.PNG"));
